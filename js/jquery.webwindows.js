  ...
  /*
   ...
   $.extend($.webwindows, {
     ...
     webwindowshtml: function(data){
       WEB_WINDOWS_COUNT += 1
       return '<div class="windows drsElement" id="webwindows_'+WEB_WINDOWS_COUNT+'"> \
      	    <div class="window-header drsMoveHandle"> \
      	      <a href="#">-</a><a href="#">X</a> \
      	    </div> \
      	    '+data+'</div>'
     }
     ...
     reveal: function(data, klass) {
      ...
      var dragresize = new DragResize('dragresize',{ minWidth: 150, minHeight: 250, minLeft: 20, minTop: 20, maxLeft: 600, maxTop: 600 });
